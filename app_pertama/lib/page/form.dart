...
import 'package:app_pertama/page/to_do_page.dart';
...
class _MyFormPageState extends State<MyFormPage> {
  ...
  String cariJenjang(){
    if (jenjangSarjana) return "Sarjana";
    if (jenjangDiploma) return "Diploma";
    if (jenjangMagister) return "Magister";
    if (jenjangDoktor) return "Doktor";
